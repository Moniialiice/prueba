                    ...
                    <!--div class="form-inline"-->
                        <form class="search-form" action="resultOficio" method="post" id="oficio">
                            <div class='row form-group'>
                                ...
                                <div class='col-12 col-md-2'><label for='text-input' class=' form-control-label'>Registro de Turno</label></div>
                                <div class='col-12 col-md-4'>
                             ...
                             <div class='row form-group'>
                                <div class='col-12 col-md-2'><label for='text-input' class=' form-control-label'>Fecha Oficio Inicial</label></div>
                                <div class='col-12 col-md-4'>
                                <input class="form-control" type="text-input" id="date1" name='date1' OnKeyUp='Upper(this);'></div>
                                <div class='col-12 col-md-2'><label for='text-input' class=' form-control-label'>Fecha Oficio Final</label></div>
                                <div class='col-12 col-md-4'>
                            ...
                            <div class='row form-group'>
                                <div class='col-12 col-md-2'><label for='text-input' class=' form-control-label'>Asunto</label></div>
