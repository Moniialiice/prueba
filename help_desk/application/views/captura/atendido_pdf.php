...
<table>
	...
	METEPEC, ESTADO DE MEXICO A <?php echo $day." DE ".$months[(int)$mont]." DE ".$year."."; ?><br>OFICIO <?php echo $dato[0]->nomen_ofseg.".";?></p>
	</td><td></td></tr>
</table>
<br><br><br><br>
<table>
	<tr><td></td><td colspan="7"><label class="label_presente"><?php echo $dato[0]->nombre_atenCap."<br>".$dato[0]->cargo_atenCap."<br>PRESENTE.";?></label></td><td></td></tr>
</table>	
<br><br><br>
<table class="table_cont">
	<tr><td></td><td colspan="7"><?php echo nl2br($dato[0]->descCap);?></td><td></td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>&nbsp;</td></tr>
</table>
...
<table>
	<tr><td></td><td colspan="7"><label class="label_copia"><?php echo nl2br($dato[0]->copia_aCap);?></label>	
</td><td></td></tr>
</table>
</div><br>
<div class="footer">
