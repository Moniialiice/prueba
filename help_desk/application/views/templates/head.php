                            ...
                            <!--div main menu collapse -->
                                ...
                                <ul class='nav navbar-nav'>                    <!--h3 class='menu-title'>UI elements</h3><!-- /.menu-title -->    
                                    ...
                                    <li class='menu-item-has-children dropdown'>
                                        ...
                                        <ul class='sub-menu children dropdown-menu'>
                                            <li><i class='menu-icon fa ti-file'></i><a href='nuevaCaptura'>Alta</a></li>
                                            <li><i class='menu-icon fa ti-file'></i><a href='nuevoCAtendido'>Atendido</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class='menu-item-has-children dropdown'>
                                        ...
                                        <ul class='sub-menu children dropdown-menu'>
                                            <li><i class='menu-icon fa fa-list-alt'></i><a href='consultaEnCap'>Consulta Recepción</a></li>
                                        </ul>
                                    </li>
                                    <li class='menu-item-has-children dropdown'>    
