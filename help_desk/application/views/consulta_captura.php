            ...
            <div class='page-header float-right'>
                <div class='page-title'>
                    <ol class='breadcrumb text-right'>
                        <li><a href='imprimirOficio/".$dato->id_ofseg."' target='_blank'><img src='assets/img/pdf.png' width='30' height='30'></a></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class='col-lg-9'>
                <div class='card'>
                    <div class='card-header'>
                        <strong>Consulta Oficio Seguimiento Datos Captura</strong>
                    </div>
            ...
            echo"<br>    <form action='#' method='' enctype='multipart/form-data' class='form-horizontal'>";
                                echo "<div class='row form-group'>
                                        ...
                                        <div class='col-12 col-md-9'>
                                            <input type='text' id='disabled-input' name='nomenclatura' class='form-control' value='".$dato->nomen_ofseg."' disabled></div>
                                       </div> ";
                                echo "<div class='row form-group'>
                                        <div class='col col-md-3'><label for='text-input' class='form-control-label'>Asunto</label></div>
                                         <div class='col-12 col-md-9'>
                                            <textarea name='asunto' id='textarea-input' rows='3' class='form-control' disabled>".$dato->asunto_ofseg."</textarea></div>
                                    </div>";
                                echo "<div class='row form-group'>
                                ...
                                echo "</div>
                                    <div class='row form-group'>
                                        ...
                                        <div class='col-12 col-md-9'><textarea name='observaciones' id='textarea-input' rows='9' class='form-control' disabled>".$dato->obs_ofseg."</textarea></div>
                                    </div>
                                    <div class='row form-group'>
